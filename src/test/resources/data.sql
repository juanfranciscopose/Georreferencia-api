...
INSERT INTO data.ugs (id, nombre_corto, nombre_largo, accesos, descripcion, barrio_id, localidad_id, ciudad_id, provincia_id, fecha_creacion, fecha_actualizacion) 
VALUES (1, 'UG-CENTRO-1', 'Unidad de Gestion Centro 1', 'Acceso Principal', 'Zona céntrica comercial', 10, 100, 500, 1, NOW(), NULL);
INSERT INTO data.ugs (id, nombre_corto, nombre_largo, accesos, descripcion, barrio_id, localidad_id, ciudad_id, provincia_id, fecha_creacion, fecha_actualizacion) 
